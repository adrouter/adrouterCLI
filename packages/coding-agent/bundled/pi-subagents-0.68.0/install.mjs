...
/**
 * pi-subagents source installer for AdRouterCLI
 *
 * Usage:
 *   npx pi-subagents          # Install to ~/.adrouter/agent/extensions/subagent
...
const AGENT_DIR = process.env.ADROUTER_CODING_AGENT_DIR || path.join(os.homedir(), ".adrouter", "agent");
