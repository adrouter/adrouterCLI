...
const ADROUTER_NESTED_DELEGATION_ENABLED = false;
...
export default function registerFanoutChildSubagentExtension(pi: ExtensionAPI): void {
	if (
		!ADROUTER_NESTED_DELEGATION_ENABLED ||
	...
	const tool: ToolDefinition<typeof SubagentParams, Details> = {
		...
		description: [
			...
			"Allowed management/control actions: list, get, models, children, status, interrupt, stop, resume, doctor.",
