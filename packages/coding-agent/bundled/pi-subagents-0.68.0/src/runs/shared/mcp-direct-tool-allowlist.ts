...
function getConfigPaths(cwd: string): string[] {
	...
	const projectAdRouterPath = path.resolve(cwd, ".adrouter", "mcp.json");
	...
	if (projectAdRouterPath !== piGlobalPath && projectAdRouterPath !== projectPath) sources.push(projectAdRouterPath);
	return sources;
}
